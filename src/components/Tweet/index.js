...
function Tweet( {conteudo, id, usuario, totalLikes, removivel, likeado, deleteTweetCallback} ) { //desestruturando. Poderia passar props e na hora de chamar fzr props.texto
